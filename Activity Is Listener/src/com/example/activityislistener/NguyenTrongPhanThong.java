...
public class NguyenTrongPhanThong extends Activity implements OnClickListener{
	EditText Ten, ChieuCao,CanNang, BMI, ChuanDoan;
	Button nut;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nguyen_trong_phan_thong);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.nguyen_trong_phan_thong, menu);
        return true;
    }
